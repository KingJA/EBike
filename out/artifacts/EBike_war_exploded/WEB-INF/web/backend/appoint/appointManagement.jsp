...
<script src="/backend/appoint/js/appointManagement-table-ajax.js"></script>
<script>
var oAppointManagementTable;
var activeTab = "${activeTab}";
var appointManagementURL = "/backendappoint/queryAppointMap";
...
function authAppoint(queryParams) {
    ...
    window.location.href = "/backendappoint/getAppoint?id="+arr[0];
}
