					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet-body">
						  ...
						  <div class="portlet-body form">
									<form <c:if test="${doType eq 'add'}">action="/backenduser/saveAdmin"</c:if>  <c:if test="${doType eq 'edit'}">action="/backenduser/updateAdmin"</c:if> method="post" id="form_user" class="form-horizontal">
										<div class="form-body">
...
<script src="/backend/user/js/form-admin-validation.js" ></script>
<!-- 上传文件 -->
