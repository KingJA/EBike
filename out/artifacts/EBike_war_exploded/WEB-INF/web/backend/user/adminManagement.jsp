...
<script src="/backend/user/js/adminManagement-table-ajax.js"></script>
<script>
var oUserManagementTable;
var activeTab = "${activeTab}";
var userManagementURL = "/backenduser/queryAdminMap";
jQuery(document).ready(function() {     
    ...
    $('#userManagement_addBtn').on( 'click', function () {
	       window.location.href = "/backenduser/newAdmin";
	    } );
});

function editUser(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "/backenduser/getAdmin?id="+arr[0];
}
                     ...
                     callback: function() {
                    	    $.ajax({  
				                ...
				                success : function(data) {  
				                	 window.location.href = "/backenduser/adminManagement?activeTab=tab_0";
				                },  
				                error : function() {  
				                   //serverError3.show();
				                }  
