...
<script src="/backend/user/js/userManagement-table-ajax.js"></script>
<script>
var oUserManagementTable;
var activeTab = "${activeTab}";
var userManagementURL = "/backenduser/queryMap";
jQuery(document).ready(function() {     
   ...
   /* $('#userManagement_addBtn').on( 'click', function () {
	       window.location.href = "/backenduser/newUser";
	    } );*/
});

function editUser(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "/backenduser/getUser?id="+arr[0];
}
