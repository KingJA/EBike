						...
						<div class="tab-content">
							<div class="tab-pane fade" id="tab_0">
								<!-- BEGIN EXAMPLE TABLE PORTLET-->
								 <jsp:include page="tabs/userManagement-tab.jsp"></jsp:include> 
...
<script src="/EBike/backend/user/js/userManagement-table-ajax.js"></script>
<script>
var oUserManagementTable;
var activeTab = "${activeTab}";
var userManagementURL = "/EBike/backenduser/queryMap";
jQuery(document).ready(function() {     
	...
	$("#menu_2").text("车主/用户管理");
    App.init();
    oUserManagementTable =  UserTableAjax.init();
    ...
    $("#userManagement tbody tr").click( function( e ) {
        if ( $(this).hasClass('active') ) {
            $(this).removeClass('active');
        }
        else {
            oUserManagementTable.$('tr.active').removeClass('active');
            $(this).addClass('active');
        } 
    });

   /* $('#userManagement_addBtn').on( 'click', function () {
	       window.location.href = "/EBike/backenduser/newUser";
	    } );*/
});

function editUser(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "/EBike/backenduser/getUser?id="+arr[0];
}

function deleteUser(queryParams) {
   var arr = queryParams.split(",");
                  ...
                  main: {
                   ...
                   success: {
                     ...
                     callback: function() {
                    	    $.ajax({  
				                type : 'POST',  
				                url :"/EBike/backenduser/deleteUser" ,  
		                        data:{"id" : arr[0]} ,
				                dataType : 'json', 
				                async : false,  //同步
