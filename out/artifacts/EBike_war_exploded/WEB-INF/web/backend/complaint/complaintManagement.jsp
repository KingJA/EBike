...
<script src="/backend/complaint/js/complaintManagement-table-ajax.js"></script>
<script>
var oComplaintManagementTable;
var activeTab = "${activeTab}";
var complaintManagementURL = "/backendcomplaint/queryComplaintMap";
...
function authComplaint(queryParams) {
    ...
    window.location.href = "/backendcomplaint/getComplaint?id="+arr[0];
}
