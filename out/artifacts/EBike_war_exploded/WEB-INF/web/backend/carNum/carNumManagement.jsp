						...
						<div class="tab-content">
							<div class="tab-pane fade" id="tab_0">
								<!-- BEGIN EXAMPLE TABLE PORTLET-->
								 <jsp:include page="tabs/carNumManagement-tab.jsp"></jsp:include> 
...
jQuery(document).ready(function() {     
	...
	$("#menu_2").text("选号管理");
    App.init();
    oCarNumManagementTable =  CarNumTableAjax.init();
    ...
    $("#carNumManagement tbody tr").click( function( e ) {
        if ( $(this).hasClass('active') ) {
            $(this).removeClass('active');
        }
        else {
            oCarNumManagementTable.$('tr.active').removeClass('active');
