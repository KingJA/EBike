					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet-body">
						  ...
						  <div class="portlet-body form">
									<form <c:if test="${doType eq 'add'}">action="/backendcarNum/saveCarNumber"</c:if>  <c:if test="${doType eq 'edit'}">action="/backendcarNum/updateCarNumber"</c:if> method="post" id="form_carNum" class="form-horizontal">
										<div class="form-body">
...
<script src="/backend/carNum/js/form-carNum-validation.js" ></script>
<!-- 上传文件 -->
