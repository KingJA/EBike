					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet-body">
						  ...
						  <div class="portlet-body form">
									<form <c:if test="${doType eq 'add'}">action="/EBike/backendads/saveAds"</c:if>  <c:if test="${doType eq 'edit'}">action="/EBike/backendads/updateAds"</c:if> method="post" id="form_ads" class="form-horizontal">
...
<script src="/EBike/backend/ads/js/form-ads-validation.js" ></script>
<!-- 上传文件 -->
