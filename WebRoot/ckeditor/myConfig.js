...
//    filebrowserFlashUploadUrl = '/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Flash';//上传Flash按钮(标签)
    ...
    config.filebrowserUploadUrl = '/CKFinder/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Files',  
    config.filebrowserImageUploadUrl = '/CKFinder/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Images',   
    config.filebrowserFlashUploadUrl = '/CKFinder/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Flash',
