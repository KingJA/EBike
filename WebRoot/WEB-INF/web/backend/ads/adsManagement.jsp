...
<script src="/backend/ads/js/adsManagement-table-ajax.js"></script>
<script>
var oAdsManagementTable;
var activeTab = "${activeTab}";
var adsManagementURL = "/backendads/queryMap";
jQuery(document).ready(function() {     
    ...
    $('#adsManagement_addBtn').on( 'click', function () {
	       window.location.href = "/backendads/newAds";
	    } );
...
function editAds(queryParams) {
    ...
    window.location.href = "/backendads/getAds?id="+arr[0];
}
