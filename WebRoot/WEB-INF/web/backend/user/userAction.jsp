					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet-body">
						  ...
						  <div class="portlet-body form">
									<form <c:if test="${doType eq 'add'}">action="/backenduser/saveUser"</c:if>  <c:if test="${doType eq 'edit'}">action="/backenduser/updateUser"</c:if> method="post" id="form_user" class="form-horizontal">
										<div class="form-body">
...
<script src="/backend/user/js/form-user-validation.js" ></script>
<!-- 上传文件 -->
...
jQuery(document).ready(function() {   
	...
	$("#menu_2").text("车主/用户管理");
	   ...
	   $('#cancelBtn').on( 'click', function () {
	       window.location.href = "/backenduser/userManagement?activeTab=tab_0";
	    } );
