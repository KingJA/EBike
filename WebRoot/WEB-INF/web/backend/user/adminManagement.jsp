...
<script src="/EBike/backend/user/js/adminManagement-table-ajax.js"></script>
<script>
var oUserManagementTable;
var activeTab = "${activeTab}";
var userManagementURL = "/EBike/backenduser/queryAdminMap";
jQuery(document).ready(function() {     
    ...
    $('#userManagement_addBtn').on( 'click', function () {
	       window.location.href = "/EBike/backenduser/newAdmin";
	    } );
});

function editUser(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "/EBike/backenduser/getAdmin?id="+arr[0];
}
