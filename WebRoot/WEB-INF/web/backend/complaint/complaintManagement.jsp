						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="tab_0">
								<!-- BEGIN EXAMPLE TABLE PORTLET-->
								 <jsp:include page="tabs/complaintManagement-tab.jsp"></jsp:include> 
...
<script src="/EBike/backend/complaint/js/complaintManagement-table-ajax.js"></script>
<script>
var oComplaintManagementTable;
var activeTab = "${activeTab}";
var complaintManagementURL = "/EBike/backendcomplaint/queryComplaintMap";
jQuery(document).ready(function() {     
	...
	$("#menu_2").text("投诉管理");
    App.init();
    oComplaintManagementTable =  ComplaintTableAjax.init();
    ...
    $("#complaintManagement tbody tr").click( function( e ) {
...
function authComplaint(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "/EBike/backendcomplaint/getComplaint?id="+arr[0];
}
