					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet-body">
						  ...
						  <div class="portlet-body form">
									<form action="/EBike/backendappoint/updateAppoint" method="post" id="form_appoint" class="form-horizontal">
										<div class="form-body">
...
jQuery(document).ready(function() {   
	...
	$("#menu_2").text("预约管理");
	   ...
	   $('#cancelBtn').on( 'click', function () {
	       window.location.href = "/EBike/backendappoint/appointManagement?activeTab=tab_0";
	    } );
