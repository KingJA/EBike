package com.jing.pulgin.mybatis.plugin;
...
import com.jing.pulgin.jdbc.dialet.Dialect;
...
public class PagePlugin implements Interceptor {
	...
	private String generatePagesSql(String sql, PageView page) {
		if (page != null && dialectObject != null) {
			//pageNow默认是从1，而数据库是从0开始计算的．所以(page.getPageNow()-1)
...
//			return dialectObject.getLimitString(sql, ((pageNow<=0?0:pageNow-1)
//					* page.getPageSize()), ((page.getPageSize() * pageNow)-1));
		}
		return sql;
	}
