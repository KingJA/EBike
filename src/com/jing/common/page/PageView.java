...
public class PageView {
	...
	public void setClientPageIndex(long pageNow, long pageCount, long pageSize, long rowCount){
		this.pageIndex = WebTool.getClientPageIndex(pageNow, pageCount,pageSize,rowCount);
	}
